    ...
    useEffect(() => {
        ...
        const loadParticipants = async () => {
            try {
                ...
                // Match splitBetween names to user IDs
                const splitIds = expense.splitBetween
                    .map(name => {
                        const participant = mapped.find(p => p.name === name);
            ...
            <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                ...
                >
                    <div className="flex items-center justify-between p-6 border-b sticky top-0 bg-background z-10">
                        <h3 className="text-lg font-bold">{t.editExpense}</h3>
                        <button 
                            onClick={() => onOpenChange(false)} 
                    ...
                    <form onSubmit={handleSubmit} className="p-6 space-y-4">
                        ...
                        <div>
                            ...
                            <div className="w-full px-4 py-3 rounded-xl border border-input bg-muted text-muted-foreground">
                                {expense.paidByName}
                            </div>
