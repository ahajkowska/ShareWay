...
_s(VotingCard, "82N5KF9nLzZ6+2WH7KIjzIXRkLw=", false, function() {
    return [
...
_s(CreateVotingDialog, "hvRoOrACscglCLrL9s5aW4WF95c=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$context$2f$LanguageContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useI18n"]
    ];
});
...
//                       {t.voting.peopleVoted || "osób zagłosowało"}
//                     </p>
//                   </CardContent>
//                 </Card>
//                 <Card>
...
//                     <p className="text-xs text-muted-foreground">
//                       {t.voting.totalVotesCast || "łącznie oddanych głosów"}
//                     </p>
//                   </CardContent>
//                 </Card>
//                 <Card>
...
//                               {t.voting.whoVoted || "Kto głosował?"} ({option.votes.length})
//                             </summary>
//                             <ul className="mt-2 space-y-1 pl-4">
//                               {option.votes.map((vote) => (
//                                 <li key={vote.id} className="text-xs">
//                                   • {vote.userName} - {new Date(vote.votedAt).toLocaleDateString(t.voting.locale)}
//                                 </li>
//                               ))}
//                             </ul>
//                           </details>
...
//                     {t.voting.pollInfo || "Informacje o głosowaniu"}
//                   </CardTitle>
//                 </CardHeader>
...
//# sourceMappingURL=_b6eb28c9._.js.map