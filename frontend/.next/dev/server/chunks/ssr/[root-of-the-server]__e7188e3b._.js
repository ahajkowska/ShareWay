...
function ChecklistPage() {
    ...
    const load = async ()=>{
        try {
            setLoading(true);
            setError(null);
            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchChecklist"](groupId);
    ...
    const handleAdd = async (text)=>{
        try {
            const newItem = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["addChecklistItem"](groupId, text);
    ...
    const handleToggle = async (itemId, newChecked)=>{
        ...
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toggleChecklistItemStatus"](itemId, newChecked);
        } catch (err) {
            console.error(err);
            setItems((prev)=>prev.map((i)=>i.id === itemId ? {
                        ...i,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e7188e3b._.js.map