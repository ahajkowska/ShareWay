...
"[project]/frontend/lib/prebakedQueries.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
let prebakedQueries = {};
let prebakedQueriesExtra = {};
// Załaduj pliki bezpiecznie - jeśli nie istnieją, nie przerywa aplikacji
try {
    prebakedQueries = (()=>{
        const e = new Error("Cannot find module '@/data/prebakedQueries.json'");
...
try {
    prebakedQueriesExtra = (()=>{
        const e = new Error("Cannot find module '@/data/prebakedQueriesExtra.json'");
        e.code = 'MODULE_NOT_FOUND';
        throw e;
    })();
} catch (error) {
...
function getPrebakedQueries(destination) {
    try {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$prebakedQueries$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/frontend/lib/prebakedQueries.ts [app-route] (ecmascript)");
;
...
function buildDestinationQueries(destination, preset = "neutral") {
    ...
    const extraFromPrebaked = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$prebakedQueries$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getPrebakedQueries"])(destination);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__92fec0e8._.js.map